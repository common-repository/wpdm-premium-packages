 ...
 *
 * This template can be overridden by copying it to yourtheme/download-manager/checkout-cart-2col/checkout-name-email.php.
 *
 * @version     1.0.0
 */
...
<div class="card mb-3 mt-3">
    <div class="card-header"><strong><?php echo __("Please Enter Your Name & Email", "wpdm-premium-packages"); ?></strong></div>
    <div class="card-body">
        <!-- full-name input-->
