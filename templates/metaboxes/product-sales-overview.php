...
$total_sales = wpdmpp_total_sales('', $pid, "1990-01-01", wp_date("Y-m-d", strtotime('Tomorrow')));
...
$daily_sales = wpdmpp_daily_sales('',$pid, wp_date("Y-m-d", strtotime("-6 Days")), wp_date("Y-m-d", strtotime("Tomorrow")));
...
<div class="w3eden">
        ...
        jQuery.getScript('https://www.gstatic.com/charts/loader.js', function () {
            ...
            function drawChart() {
                var data = google.visualization.arrayToDataTable([
                    ...
                    ['<?php echo wp_date("D", strtotime($date)); ?>',  <?php echo $sale;?>,      <?php echo $daily_sales['quantities'][$date];?>] <?php if($dn++ < 6) echo ','; else break; ?>
                    <?php } ?>
                ]);
    ...
    <div class="row text-center">
        <div class="col-md-6">
            <div class="panel panel-default">
                <div class="panel-body"><h2><?php echo wpdmpp_currency_sign().number_format($daily_sales['sales'][wp_date("Y-m-d")],2); ?></h2></div>
                <div class="panel-footer"><?php _e('Today','wpdm-premium-packages'); ?></div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="panel panel-default">
                <div class="panel-body"><h2><?php echo wpdmpp_currency_sign().number_format($daily_sales['sales'][wp_date("Y-m-d", strtotime("Yesterday"))],2); ?></h2></div>
    ...
    <div class="list-group" style="margin: 0">
        ...
        <div class="list-group-item">
            <span class="badge pull-right"><?php echo wpdmpp_currency_sign().wpdmpp_total_sales('', $pid, $ldolw, wp_date("Y-m-d", strtotime("Tomorrow")))?></span>
        ...
        <div class="list-group-item">
            <span class="badge pull-right"><?php echo wpdmpp_currency_sign().wpdmpp_total_sales('', $pid, wp_date("Y-m-01"), wp_date("Y-m-d", strtotime("Tomorrow")))?></span>
        ...
        <div class="list-group-item">
            <span class="badge pull-right"><?php echo wpdmpp_currency_sign().number_format(wpdmpp_total_sales('', $pid, wp_date("Y-01-01"), wp_date("Y-m-d", strtotime("Tomorrow"))),2,'.',',');?></span>
            <?php _e('This Year','wpdm-premium-packages'); ?>
        </div>
        <div class="list-group-item">
            <span class="badge pull-right"><?php echo wpdmpp_currency_sign().number_format(wpdmpp_total_sales('', $pid, "$last_year-01-01", wp_date("Y-01-01")),2,'.',',');?></span>
